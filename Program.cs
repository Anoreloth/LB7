...
namespace LB_7
{
    ...
    class Building : City
    {
        ...
        public Building(string name, string street, int houseNumber, double totalSquare,
       double payment) : base(name)
        {
            this.street = street;
    ...
    class Rooms : Building
    {
        ...
        public Rooms(string name, string street, int houseNumber, double totalSquare,
       double payment, int number, double square) : base(name, street, houseNumber, totalSquare,
       payment)
        {
            this.number = number;
            this.square = square;
    ...
    class Flat : Rooms
    {
        ...
        public Flat(string name, string street, int houseNumber, double totalSquare,
       double payment, int number, double square) : base(name, street, houseNumber, totalSquare,
       payment, number, square)
        { }
        string x;
        public void Add()
        {
    ...
    class Office : Rooms
    {
        ...
        public Office(string name, string street, int houseNumber, double totalSquare,
       double payment, int number, double square, string firm, string activity) : base(name,
       street, houseNumber, totalSquare, payment, number, square)
        {
            this.firm = firm;
 ...
 new Flat("Кам'янець-Подiльський", "Драй-Хмари", 8, 728.33, 4.752, 2, 0),
            ...
            City[] city2 = {
 new Office("Львiв", "Алмазна", 7, 2967.78, 13.157, 0, 0, "ТОВ ЛьвiвБуд",
"будiвництво"),
 new Office("Львiв", "Бузкова", 13, 4971, 18.097, 0, 0, "ТОВ ЛьвiвАвто",
"виготовлення автiвок")
 };
